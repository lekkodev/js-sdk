...
export class Tree extends Message<Tree> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 4, name: "comments_before_return", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
  ]);
...
export class Constraint extends Message<Constraint> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 3, name: "constraints", kind: "message", T: Constraint, repeated: true },
    { no: 4, name: "rule_ast", kind: "message", T: Rule },
    { no: 5, name: "rule_ast_new", kind: "message", T: Rule$1 },
    { no: 6, name: "value_new", kind: "message", T: Any },
    { no: 7, name: "comments_before_if", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
    { no: 8, name: "comments_before_return", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
  ]);
