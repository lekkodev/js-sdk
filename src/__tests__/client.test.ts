...
test("Test JFGI", () => {
          ...
          enumType: [
            {
              name: "DogBreed",
              value: [
                { name: "DOG_BREED_UNSPECIFIED", number: 0 },
                { name: "DOG_BREED_POMERANIAN", number: 1 },
                { name: "DOG_BREED_GOLDEN_RETRIEVER", number: 2 },
                { name: "DOG_BREED_POODLE", number: 3 },
                { name: "DOG_BREED_MALTESE", number: 4 },
              ],
            },
          ],
          sourceCodeInfo: {
            location: [
              ...
              { path: [12], span: [0, 0, 18] },
              { path: [2], span: [2, 0, 31] },
              { path: [4, 0], span: [4, 0, 6, 1] },
              { path: [4, 0, 1], span: [4, 8, 11] },
              { path: [4, 0, 2, 0], span: [5, 4, 19] },
              { path: [4, 0, 2, 0, 5], span: [5, 4, 10] },
              { path: [4, 0, 2, 0, 1], span: [5, 11, 14] },
              { path: [4, 0, 2, 0, 3], span: [5, 17, 18] },
              { path: [5, 0], span: [8, 0, 14, 1] },
              { path: [5, 0, 1], span: [8, 5, 13] },
              { path: [5, 0, 2, 0], span: [9, 4, 30] },
              { path: [5, 0, 2, 0, 1], span: [9, 4, 25] },
              { path: [5, 0, 2, 0, 2], span: [9, 28, 29] },
              { path: [5, 0, 2, 1], span: [10, 4, 29] },
              { path: [5, 0, 2, 1, 1], span: [10, 4, 24] },
              { path: [5, 0, 2, 1, 2], span: [10, 27, 28] },
              { path: [5, 0, 2, 2], span: [11, 4, 35] },
              { path: [5, 0, 2, 2, 1], span: [11, 4, 30] },
              { path: [5, 0, 2, 2, 2], span: [11, 33, 34] },
              { path: [5, 0, 2, 3], span: [12, 4, 25] },
              { path: [5, 0, 2, 3, 1], span: [12, 4, 20] },
              { path: [5, 0, 2, 3, 2], span: [12, 23, 24] },
              { path: [5, 0, 2, 4], span: [13, 4, 26] },
              { path: [5, 0, 2, 4, 1], span: [13, 4, 21] },
              { path: [5, 0, 2, 4, 2], span: [13, 24, 25] },
              { path: [4, 1], span: [16, 0, 18, 1] },
              { path: [4, 1, 1], span: [16, 8, 11] },
              { path: [4, 1, 2, 0], span: [17, 4, 21] },
              { path: [4, 1, 2, 0, 5], span: [17, 4, 10] },
              { path: [4, 1, 2, 0, 1], span: [17, 11, 16] },
              { path: [4, 1, 2, 0, 3], span: [17, 19, 20] },
              { path: [4, 2], span: [20, 0, 29, 1] },
              { path: [4, 2, 1], span: [20, 8, 15] },
              { path: [4, 2, 2, 0], span: [21, 8, 25] },
              { path: [4, 2, 2, 0, 5], span: [21, 8, 14] },
              { path: [4, 2, 2, 0, 1], span: [21, 15, 20] },
              { path: [4, 2, 2, 0, 3], span: [21, 23, 24] },
              { path: [4, 2, 2, 1], span: [22, 8, 24] },
              { path: [4, 2, 2, 1, 5], span: [22, 8, 14] },
              { path: [4, 2, 2, 1, 1], span: [22, 15, 19] },
              { path: [4, 2, 2, 1, 3], span: [22, 22, 23] },
              { path: [4, 2, 2, 2], span: [23, 8, 23] },
              { path: [4, 2, 2, 2, 5], span: [23, 8, 14] },
              { path: [4, 2, 2, 2, 1], span: [23, 15, 18] },
              { path: [4, 2, 2, 2, 3], span: [23, 21, 22] },
              { path: [4, 2, 2, 3], span: [24, 8, 23] },
              { path: [4, 2, 2, 3, 5], span: [24, 8, 14] },
              { path: [4, 2, 2, 3, 1], span: [24, 15, 18] },
              { path: [4, 2, 2, 3, 3], span: [24, 21, 22] },
              { path: [4, 2, 2, 4], span: [25, 8, 24] },
              { path: [4, 2, 2, 4, 5], span: [25, 8, 14] },
              { path: [4, 2, 2, 4, 1], span: [25, 15, 19] },
              { path: [4, 2, 2, 4, 3], span: [25, 22, 23] },
              { path: [4, 2, 2, 5], span: [26, 8, 28] },
              { path: [4, 2, 2, 5, 5], span: [26, 8, 14] },
              { path: [4, 2, 2, 5, 1], span: [26, 15, 23] },
              { path: [4, 2, 2, 5, 3], span: [26, 26, 27] },
              { path: [4, 2, 2, 6], span: [27, 8, 28] },
              { path: [4, 2, 2, 6, 5], span: [27, 8, 14] },
              { path: [4, 2, 2, 6, 1], span: [27, 15, 23] },
              { path: [4, 2, 2, 6, 3], span: [27, 26, 27] },
              { path: [4, 2, 2, 7], span: [28, 8, 27] },
              { path: [4, 2, 2, 7, 5], span: [28, 8, 14] },
              { path: [4, 2, 2, 7, 1], span: [28, 15, 22] },
              { path: [4, 2, 2, 7, 3], span: [28, 25, 26] },
            ],
          },
          syntax: "proto3",
        },
  ...
  const client = new Backend(transport, "", "", "", registry, store)
