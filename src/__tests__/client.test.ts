...
import { Any, BinaryWriter, BoolValue, createRegistryFromDescriptors, FileDescriptorSet, protoBase64, WireType } from "@bufbuild/protobuf"
                ...
                tree: {
                  defaultNew: {
                    ...
                    value: protoBase64.enc(
                      new BinaryWriter().tag(1, WireType.LengthDelimited).string("Collie").finish())
                  },
                },
